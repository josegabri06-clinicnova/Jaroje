    ...
    if (localRes) {
      ...
      return NextResponse.json({
        ...
        data: {
          ...
          individual_num_adult: Number(localRes.num_adult || 1),
          individual_num_child: Number(localRes.num_child || 0),
      ...
      try {
        ...
        return NextResponse.json({
          ...
          data: {
            ...
            individual_num_adult: Number(booking.num_adult || 1),
            individual_num_child: Number(booking.num_child || 0),
